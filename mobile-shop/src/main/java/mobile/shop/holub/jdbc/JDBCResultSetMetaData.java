...
import mobile.shop.holub.jdbc.adapters.ResultSetMetaDataAdapter;

/**
 * A limited version of the result-set metadata class. All methods not shown throw a {@link SQLException} if called.
 *
...
public class JDBCResultSetMetaData extends ResultSetMetaDataAdapter {
    ...
    public String getColumnName(int index)
            throws SQLException {    // The Cursor is zero indexed, which makes sense from a Java
