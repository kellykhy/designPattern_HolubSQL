...
public class ResultSetAdapter implements ResultSet {
    ...
    public Date getDate(String columnIndex, java.util.Calendar cal) throws SQLException {
    ...
    public void updateClob(Clob c) throws SQLException {
        throw new SQLException("ResultSet.updateClob(Clob c) unsupported");
    }
    ...
    public void updateDate(String colIndex, Date d) throws SQLException {
        throw new SQLException("ResultSet.updateDate(String colIndex, java.sql.Date d) unsupported");
    }

    public void updateTime(String colIndex, Time t) throws SQLException {
        throw new SQLException("ResultSet.updateTime(String colIndex, java.sql.Time t) unsupported");
    }

    public void updateTimestamp(String colIndex, Timestamp t) throws SQLException {
        throw new SQLException("ResultSet.updateTimestamp(String colIndex, java.sql.Timestamp t) unsupported");
    }

    public void updateAsciiStream(String colIndex, InputStream in, int s) throws SQLException {
        throw new SQLException(
                "ResultSet.updateAsciiStream(String colIndex, java.io.InputStream in, int s) unsupported");
    }

    public void updateBinaryStream(String colIndex, InputStream in, int s) throws SQLException {
        throw new SQLException(
                "ResultSet.updateBinaryStream(String colIndex, java.io.InputStream in, int s) unsupported");
    }

    public void updateCharacterStream(String colIndex, Reader in, int s) throws SQLException {
        throw new SQLException(
                "ResultSet.updateCharacterStream(String colIndex, java.io.Reader in, int s) unsupported");
    }
    ...
    public void checkClosed() throws SQLException {
        throw new SQLException("ResultSet.checkClosed() unsupported");
    }
