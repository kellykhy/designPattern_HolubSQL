...
/**
 * Recognize a token that looks like a word. The match is case insensitive. To be recognized, the input must match the
 * pattern passed to the constructor, and must be followed by a non-letter-or-digit. The returned lexeme is always
